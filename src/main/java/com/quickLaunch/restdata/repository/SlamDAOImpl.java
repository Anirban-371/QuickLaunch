package com.quickLaunch.restdata.repository;
...
import com.quickLaunch.restdata.model.Customer;
import com.quickLaunch.restdata.model.User;
...
public class SlamDAOImpl {
     ...
     * @throws Exception 
     */
	public void saveUserDetails(User user) throws Exception { //throws Exception is optional, it is required as I have added "throw new Exception();" in catch 
